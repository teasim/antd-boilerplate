...
function languageIsSupported(language) {
  try {
    fs.accessSync(`client/application/translations/${language}.json`, fs.F_OK);
    return true;
  } catch (e) {
    return false;
  }
...
module.exports = {
  ...
  actions: () => {
    ...
    actions.push({
      type: 'modify',
      path: '../../client/application/helpers/i18n.js',
    ...
    actions.push({
      type: 'modify',
      path: '../../client/application/helpers/i18n.js',
      pattern: /(from\s'application\/translations\/[a-z]+.json';\n)(?!.*from\s'application\/translations\/[a-z]+.json';)/g,
    ...
    actions.push({
      type: 'add',
      path: '../../client/application/translations/{{language}}.json',
      templateFile: './language/translations-json.hbs',
      abortOnFail: true,
    });
    actions.push({
      type: 'modify',
      path: '../../client/application/entries/app.js',
