...
import { makeSelectLocationState } from 'application/containers/App/selectors';

// Import Language Provider
import LanguageProvider from 'application/containers/LanguageProvider';
...
import '!file-loader?name=[name].[ext]!assets/images/manifest.json';
import 'file-loader?name=[name].[ext]!.htaccess';
/* eslint-enable import/no-unresolved, import/extensions */

import configureStore from 'application/stores/store';

// Import i18n messages
import { translationMessages } from 'application/helpers/i18n';

// Import CSS reset and Global Styles
import 'application/styles/global-styles';

// Import root routes
import createRoutes from 'application/routes/routes';
...
// Hot reloadable application json files
if (module.hot) {
  // modules.hot.accept does not accept dynamic dependencies,
  // have to be constants at compile-time
  module.hot.accept('application/helpers/i18n', () => {
