...
import '!file-loader?name=[name].[ext]!assets/icons/icon-72x72.png';
import '!file-loader?name=[name].[ext]!assets/icons/icon-96x96.png';
import '!file-loader?name=[name].[ext]!assets/icons/icon-120x120.png';
import '!file-loader?name=[name].[ext]!assets/icons/icon-128x128.png';
import '!file-loader?name=[name].[ext]!assets/icons/icon-144x144.png';
import '!file-loader?name=[name].[ext]!assets/icons/icon-152x152.png';
import '!file-loader?name=[name].[ext]!assets/icons/icon-167x167.png';
import '!file-loader?name=[name].[ext]!assets/icons/icon-180x180.png';
import '!file-loader?name=[name].[ext]!assets/icons/icon-192x192.png';
import '!file-loader?name=[name].[ext]!assets/icons/icon-384x384.png';
import '!file-loader?name=[name].[ext]!assets/icons/icon-512x512.png';
